...
const fallbackServices = [
  {
    ...
    price: 85000,
    durationMinutes: 45,
    imageUrl: '/acqua-centro-estetica/assets/services/relleno-labios.jpeg'
  },
  {
    _id: '2',
    name: 'Rinomodelacion',
    ...
    price: 110000,
    durationMinutes: 50,
    imageUrl: '/acqua-centro-estetica/assets/services/rinomodelacion.jpeg'
  },
  {
    _id: '3',
    ...
    price: 95000,
    durationMinutes: 40,
    imageUrl: '/acqua-centro-estetica/assets/services/toxina-botulinica.jpeg'
  },
  {
    _id: '4',
    name: 'Plasma facial',
    ...
    price: 65000,
    durationMinutes: 60,
    imageUrl: '/acqua-centro-estetica/assets/services/plasma-facial.png'
  },
  {
    _id: '5',
    name: 'Criolipolisis',
    ...
    price: 78000,
    durationMinutes: 70,
    imageUrl: '/acqua-centro-estetica/assets/services/criolipolisis.png'
  }
];
...
const fallbackProducts = [
  {
    ...
    price: 18500,
    stock: 18,
    imageUrl: '/acqua-centro-estetica/assets/products/crema-nutritiva.jpeg'
  },
  {
    _id: 'p2',
    ...
    price: 24000,
    stock: 12,
    imageUrl: '/acqua-centro-estetica/assets/products/crema-dline.jpeg'
  },
  {
    _id: 'p3',
    ...
    price: 29500,
    stock: 20,
    imageUrl: '/acqua-centro-estetica/assets/products/colageno.jpeg'
  }
];
    ...
    <main>
      <header className="topbar">
        <button className="brand-button" type="button" onClick={() => setView('inicio')}>
          <img src="/acqua-centro-estetica/assets/acqua-logo.jpeg" alt="Acqua Centro de Estetica" />
          <span>Acqua</span>
        </button>
        <nav>
      ...
      {view === 'inicio' && (
        <section className="hero">
          <div className="hero-copy">
            <img className="hero-logo" src="/acqua-centro-estetica/assets/acqua-logo.jpeg" alt="Acqua Centro de Estetica" />
          ...
          <div className="doctor-card">
            <img src="/acqua-centro-estetica/assets/dr-leo.jpeg" alt="Dr. Leo Grabauska" />
            <div>
          ...
          <div className="card-grid">
            {services.map((service) => (
              <article className="catalog-card" key={service._id}>
                <img src={service.imageUrl || '/acqua-centro-estetica/assets/services/default-service.svg'} alt={service.name} />
                <div>
          ...
          <div className="card-grid">
            {products.map((product) => (
              <article className="catalog-card" key={product._id}>
                <img src={product.imageUrl || '/acqua-centro-estetica/assets/services/default-service.svg'} alt={product.name} />
                <div>
